<section class="">
    <!-- Modal toggle -->
    <button data-modal-target="default-modal-category" data-modal-toggle="default-modal-category"
    ...
    <!-- Main modal -->
    <div id="default-modal-category" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="default-modal-category">
                ...
                <form action="/admin/categories" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <button data-modal-hide="default-modal-category" type="submit"
            ...
            <tbody>
                @foreach ($categories as $category)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <div class="overflow-hidden w-16 h-16 transition-all">
                                <img src="{{ asset($category->image) }}" alt="{{ $category->name }}"
                                    class="w-16 h-16 rounded-full object-cover hover:scale-150 hover:rounded-none transition-all">
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            {{ $category->name }}
                        ...
                        <td class="px-6 py-4 flex flex-col justify-center space-y-2 items-center">
                            @include('admin.product.edit-category', ['category' => $category])
                            <form action="/admin/categories" method="post">
                                @csrf
                                @method('delete')
                                <input type="number" hidden value="{{ $category->id }}" name="category_id">
                                <button data-tooltip-target="tooltip-delete" type="submit" class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round"
