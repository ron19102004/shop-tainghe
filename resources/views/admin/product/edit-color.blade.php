<button data-modal-target="default-modal-color{{ $color->id }}" data-tooltip-target="tooltip-color{{ $color->id }}"
    data-modal-toggle="default-modal-color{{ $color->id }}" class="" type="button">
...
<div id="tooltip-color{{ $color->id }}" role="tooltip"
    class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
    Sửa danh mục
    <div class="tooltip-arrow" data-popper-arrow></div>
</div>
<!-- Main modal -->
<div id="default-modal-color{{ $color->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="default-modal-color{{ $color->id }}">
            ...
            <form action="/admin/colors" method="post" enctype="multipart/form-data">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    ...
                    <input type="text" name="name" id="name" placeholder="Trắng"
                        class="w-[100%] rounded outline-none h-10 text-black" value="{{ $color->name }}" required>
                    ...
                    <input type="text" name="value" id="value" placeholder="#fff"
                        class="w-[100%] rounded outline-none h-10 text-black" value="{{ $color->value }}" required>
                </div>
                <!-- Modal footer -->
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button data-modal-hide="default-modal-color{{ $color->id }}" type="submit"
